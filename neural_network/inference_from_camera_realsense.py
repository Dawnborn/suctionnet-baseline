...
parser.add_argument('--checkpoint_path', 
                    default='/data/hdd1/storage/junpeng/ws_anygrasp/suctionnet-baseline/ckpt/realsense-deeplabplus-RGBD', 
...
def inference_one_view(rgb, depth, scene_idx, anno_idx):
    
    intrinsics = np.array([894.702 , 0.,         632.479,
                          0. ,        894.702, 359.741,
                          0.,           0.,           1.        ]).reshape((3,3))
    ...
    # suction_point_cloud.normals = o3d.utility.Vector3dVector(suction_normals*2)
    ...
    # 可视化点云
    o3d.visualization.draw_geometries([point_cloud, suction_point_cloud, line_set], point_show_normal=False)
...
def inference(scene_idx):
    ...
    for anno_idx in range(10):
        ...
        inference_one_view(color, depth, scene_idx, anno_idx)
